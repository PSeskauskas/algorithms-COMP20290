...
| [Assignment](./src/Assignment) | [Assignment Sheet](./src/Assignment/COMP20290-Assignment-2-Compression.pdf) <br><br> [Answer Sheet](./HuffmanAlgorithm-Assignment-Answers-19369726.pdf) | [Huffman Algorithm](./src/Assignment/HuffmanAlgorithm.java) | Java implementation of the Huffman compression/decompression algorithm using tries to obtain a lower number of bits for characters that occur most frequently. <br> Time Complexity = O(n log n)